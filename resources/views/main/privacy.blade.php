...
<body>
  ...
  <!-- Main Navigation -->
  <div class="m-5 p-5 frames-container-application white-color">
    <div>
      <h3>Privacy Policy</h3>
      <p>Last Updated: Juni 25 2023</p>

      <p>Thank you for visiting the Privacy Policy of UNICA. This Privacy Policy explains how UNICA (collectively, “UNICA”, “we”, “us”, or “our”) collects, uses, and shares information about you (“you”, “yours” or “user”) when you access or use our websites (“Services”).</p>
      ...
      <p>To access your privacy rights, send us an email at mustfauzan0@gmail.com.</p>
  ...
  <footer class="text-center text-lg-start bg-white text-muted">
    ...
    <section class="navbar d-flex justify-content-center justify-content-lg-between p-4 border-bottom" style="background-color: #ffac4c; color: white;">
      <!-- Left -->
      ...
      <div class="container text-center text-md-start mt-5">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
            ...
            <p><i class="fas fa-phone me-3 text-secondary"></i> + 62 812 548 881 02</p>
            <p><i class="fas fa-print me-3 text-secondary"></i> + 62 812 548 881 02</p>
          </div>
          <!-- Grid column -->
        </div>
        <!-- Grid row -->
    ...
    <!-- Copyright -->
    <div class="text-center p-1" style="background-color: #ffac4c;">
      © 2023 Copyright:
      <a class="text-reset fw-bold" href="#">UNICA.id</a>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->
