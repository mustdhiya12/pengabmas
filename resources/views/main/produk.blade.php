                    ...
                    <div class="col-md-6 rdr2"><br>
                        ...
                        <style>
                            ...
                            @media (max-width: 767px) {
                                ...
                                /* Penyesuaian untuk perangkat seluler dengan lebar maksimal 767px */
                                .description-container p {
                                    font-size: 0.9em;
                        ...
                        <div class="description-container">
                            ...
                            <?php if (strlen($produk_deskripsi) > $max_length) : ?>
                                <div id="expand-description" style="display: none;">
                                    ...
                                    <a id="collapse-link" style="color: var(--border-color-4); cursor: pointer;">Sembunyikan</a>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="d-flex align-items-end flex-column">
                            <div class="p-md-3">
                                ...
                                <button class="btn btn-outline-pr btn-sm">
                                    <i class="far fa-heart me-1"></i><sup>({{ $likesCountPro }})</sup>
                                </button>
                                @else
                                @php
